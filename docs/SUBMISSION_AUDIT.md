...
It also carries **two open items that are gaps rather than deferrals**, which the plan's list does
not contain because they were found this week: the mount-disturbance detector's 10 Hz blind spot
(D-075) and the unconfirmed accelerometer sign convention (D-059). A third, Gate 0 being open, has
since closed (D-092, D-103) and §13 says so.
